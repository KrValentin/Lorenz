...
int comparaison_explicite(double T, int N, double sigma, double beta, double rho, matrix_t* x0, double epsilon )
{
    ...
    pF_output_X = fopen("stabilite/explicite/comparaison_explicite_X.txt", "w");
    pF_output_Y = fopen("stabilite/explicite/comparaison_explicite_Y.txt", "w");
    pF_output_Z = fopen("stabilite/explicite/comparaison_explicite_Z.txt", "w");
    ...
    resultats = euler_explicite(x0,T, N, sigma, beta, rho);
    set_elem(x0, 0, 0, get_elem(x0, 0,0)+eps);
    resultats_eps = euler_explicite(x0,T, N, sigma, beta, rho);
